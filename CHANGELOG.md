...
## [1.8.1](https://github.com/santifer/career-ops/compare/career-ops-v1.8.0...career-ops-v1.8.1) (2026-05-23)


### Miscellaneous

* release/VERSION sync to 1.8.1 — no functional changes. Pulled into this fork via `node update-system.mjs apply`; upstream published no changelog entry for this patch.
